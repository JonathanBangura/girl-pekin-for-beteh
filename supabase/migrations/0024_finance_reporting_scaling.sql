...
-- DIRECT GITHUB / SUPABASE DASHBOARD VERSION
--
-- Apply this SQL first in:
-- Supabase Dashboard -> SQL Editor -> New query -> Run
--
-- Then create this same file in GitHub at:
-- supabase/migrations/0024_finance_reporting_scaling.sql
--
-- Purpose:
